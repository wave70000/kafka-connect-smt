...
public abstract class ConvertOperationRedCross<R extends ConnectRecord<R>> implements Transformation<R> {
    ...
    private interface ConfigName {
        ...
        String OPTIONAL_DELETED = "delete.field";
    }
    ...
    public static final ConfigDef CONFIG_DEF = new ConfigDef()
            ...
            .define(ConfigName.WORD_MAPPING, ConfigDef.Type.LIST, Collections.EMPTY_LIST, ConfigDef.Importance.HIGH,
                    "List Mapping")
            .define(ConfigName.OPTIONAL_DELETED, ConfigDef.Type.STRING, "IsDeleted", ConfigDef.Importance.HIGH,
                    "Delete field");
    ...
    public void configure(Map<String, ?> props) {
        ...
        deletedField = config.getString(ConfigName.OPTIONAL_DELETED);
...
//            updatedValue.put(newFieldName, value.get(fieldName));
    ...
    private R applyWithSchema(R record) {
        ...
        for (Field field : value.schema().fields()) {
            ...
            // if field name equal "op"
            if (field.name().contains(fieldName)){
                final Object deleteValue = value.getStruct("param").get(deletedField);
                updatedValue.put(newFieldName, getMapping(value.get(fieldName),deleteValue));
            }
        }
    ...
    private String getMapping(Object value,Object deleteValue) {
        if (value == null || deleteValue == null) {
            return null;
        }
    ...
    public static class Key<R extends ConnectRecord<R>> extends ConvertOperationRedCross<R> {
        @Override
    ...
    public static class Value<R extends ConnectRecord<R>> extends ConvertOperationRedCross<R> {
        @Override
        protected Schema operatingSchema(R record) {
